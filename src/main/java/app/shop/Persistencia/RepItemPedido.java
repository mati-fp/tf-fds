...
public class RepItemPedido implements IRepItemPedido{
    ...
    @Override
    public <S extends ItemPedido> Iterable<S> saveAll(Iterable<S> entities) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'saveAll'");
    }

    @Override
    public void saveAll(Iterable<ItemPedido> entities, int pedido) {
        // salva todos os itens do pedido aqui
        for (ItemPedido itemPedido : entities) {
    ...
    @Override
    public Iterable<ItemPedido> findAllById(Iterable<Integer> ids) {
        // TODO Auto-generated method stub
